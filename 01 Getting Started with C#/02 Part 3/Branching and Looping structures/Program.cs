        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    if (ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 3] == "Physical description: " || ourAnimals[i, 3] == "Physical description: tbd")
                    {
                        // input a valid age for the pet without an age
                        do
                        {
                            Console.WriteLine($"Enter valid age for pet with {ourAnimals[i, 0]}: ");
                            readResult = Console.ReadLine();
                        ...
                        // input a physical description for the pet without physical description
                        do
                        {
                            Console.WriteLine($"Enter a physical description (size, color, gender, weight, housebroken) for pet with {ourAnimals[i, 0]}: ");
                            readResult = Console.ReadLine();
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        // input pet nickname for the pet without nickname
                        do
                        {
                        ...
                        // input pet personality descriptions for the pet without personality descriptions
                        do
                        {
