...
// Your work here
int quantityIndex = input.IndexOf("5000");
quantity = input.Substring(quantityIndex, 4);

int startPoint = input.IndexOf("<h2>");
int endPoint = input.LastIndexOf("</span>");

endPoint += 7;

int length = endPoint - startPoint;

output = input.Substring(startPoint, length);
